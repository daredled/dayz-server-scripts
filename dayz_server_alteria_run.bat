...
if errorlevel 1 exit /b 1
call "%~dp0dayz_workshop_mod_install.bat" %SERVER_LOCATION% %MOD_GSC_ID% %MOD_GSC_NAME%
if errorlevel 1 exit /b 1
call "%~dp0dayz_workshop_mod_install.bat" %SERVER_LOCATION% %MOD_ALTERIA_ID% %MOD_ALTERIA_NAME%
if errorlevel 1 exit /b 1
